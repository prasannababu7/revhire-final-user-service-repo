...
resource "aws_codecommit_repository" "revhire-user-repository" {
  repository_name = "revhire-user-repository-auto-final"
  description     = "A revhire user-repository on AWS CodeCommit"
}

resource "aws_iam_role" "codebuild_role" {
  name = "codebuild-service-role-for-user-auto-final"
...
resource "aws_codebuild_project" "revhire-user-build" {
  name          = "revhire-user-build-auto-final"
...
resource "aws_iam_role" "codepipeline_role" {
  name = "codepipeline-service-role-user-auto-final"
...
resource "aws_s3_bucket" "codepipeline_bucket" {
  bucket = "revhire-user-codepipeline-artifacts-auto-final"
  force_destroy = true
}
...
resource "aws_codepipeline" "revhire_job_pipeline" {
  name     = "revhire-user-pipeline-auto-final"
